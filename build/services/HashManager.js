...
class HashManager {
    cost() {
        if (!process.env.BCRYPT_COST) {
            throw new SetupError_1.SetupError("Missing cypher cost. Did you remember to create .env file?");
        }
        return Number(process.env.BCRYPT_COST);
    }
    hash(text) {
        return __awaiter(this, void 0, void 0, function* () {
            const salt = yield bcryptjs.genSalt(this.cost());
    ...
    compare(text, hash) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield bcryptjs.compare(text, hash);
        });
    }
}
